...
public class bukuForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtjns_buku = new javax.swing.JTextField();
        ...
        txtjns_buku.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtjns_bukuActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(updateBuku, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(19, 19, 19)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtjns_buku, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(54, 54, 54)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
                    .addComponent(txtjns_buku, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tambahBukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahBukuActionPerformed
        try {
            String sql = "INSERT INTO buku VALUES('" + txtkode_buku.getText() + "','" + txtjudul.getText() + "','" + txtpenerbit.getText() + "','" + txtpengarang.getText() + "','" + txtthn_terbit.getText() + "','"+txtjns_buku.getText()+"')";
    ...
    private void updateBukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBukuActionPerformed
        try {
            String sql = "UPDATE buku SET kode_buku='" + txtkode_buku.getText() + "',judul_buku='" + txtjudul.getText() + "',penerbit='" + txtpenerbit.getText() + "',pengarang='" + txtpengarang.getText() + "',thn_terbit='" + txtthn_terbit.getText() + "',jenis='" + txtjns_buku.getText() +"' WHERE kode_buku='" + txtkode_buku.getText() + "'";
            java.sql.Connection conn = (Connection) koneksi.configDB();
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            pst.execute();
            JOptionPane.showMessageDialog(null, "Penyimpanan Data Berhasil");
    ...
    private void txtjns_bukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtjns_bukuActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtjns_bukuActionPerformed
    ...
    private javax.swing.JTextField txtjns_buku;
